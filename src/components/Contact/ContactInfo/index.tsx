      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="flex md:flex-row flex-col md:items-center items-start justify-center md:gap-28 gap-8">
          ...
          <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
            ...
            <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start justify-between h-full">
              <div>
                <span className="text-midnight_text dark:text-white text-xl font-bold">Email Us</span>
                <p className="text-DeepOcean font-normal text-lg max-w-80 pt-3 pb-7 dark:text-white/50">Please feel free to drop us a line. We will respond as soon as possible.</p>
              </div>
              <div>
                <Link href="#" className="text-primary text-base font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white">
                  Leave a message
                  <svg width="23" height="17" viewBox="0 0 23 17" fill="#2F73F2" xmlns="http://www.w3.org/2000/svg" className="group-hover:fill-midnight_text dark:group-hover:fill-white">
          ...
          <div className="flex sm:flex-row flex-col items-start sm:gap-8 gap-4">
            ...
            <div className="flex md:flex-col sm:flex-row flex-col md:items-start sm:items-center items-start justify-between h-full">
              <div>
                <span className="text-midnight_text dark:text-white text-xl font-bold">Careers</span>
                <p className="text-DeepOcean font-normal text-lg max-w-80 pt-3 pb-7 dark:text-white/50">Sit ac ipsum leo lorem magna nunc mattis maecenas non vestibulum</p>
              </div>
              <div>
                <Link href="#" className="text-primary text-base font-medium flex items-center gap-3 group hover:text-midnight_text dark:hover:text-white">
                  Send an application
